                                     ...
                                     int count)
{
    for (int x = 0; x < count; ++x, ++dst, ++mask) {
        ...
        dst->b = fix15_mul(dst->b, as1) + fix15_mul(src.b, o),
        dst->g = fix15_mul(dst->g, as1) + fix15_mul(src.g, o),
        dst->r = fix15_mul(dst->r, as1) + fix15_mul(src.r, o),
        dst->a = fix15_mul(dst->a, as1) + fix15_mul(BIT15_FIX, o);
    }
}
                                                ...
                                                Fix15 opacity, int count)
{
    for (int x = 0; x < count; ++x, ++dst, ++mask) {
        ...
        dst->b = fix15_sumprods(opa_a, src.b, opa_b, dst->b);
        dst->g = fix15_sumprods(opa_a, src.g, opa_b, dst->g);
        dst->r = fix15_sumprods(opa_a, src.r, opa_b, dst->r);
