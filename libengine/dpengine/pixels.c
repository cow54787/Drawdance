...
DP_FORCE_INLINE void load_sse42(DP_Pixel15 src[4], __m128i *out_blue, __m128i *out_green, __m128i *out_red, __m128i *out_alpha)
{
...
DP_FORCE_INLINE void store_sse42(__m128i blue, __m128i green, __m128i red, __m128i alpha, DP_Pixel15 dest[4])
{
...
static void blend_pixels_normal_sse42(DP_Pixel15 *dst, DP_Pixel15 *src, int pixel_count, uint16_t opacity)
{
...
DP_FORCE_INLINE void load_avx2(DP_Pixel15 src[8], __m256i *out_blue, __m256i *out_green, __m256i *out_red, __m256i *out_alpha)
{
...
DP_FORCE_INLINE void store_avx2(__m256i blue, __m256i green, __m256i red, __m256i alpha, DP_Pixel15 dest[8])
{
...
static void blend_pixels_normal_avx2(DP_Pixel15 *dst, DP_Pixel15 *src, int pixel_count, uint16_t opacity)
{
...
#ifdef DP_CPU_X64
static void blend_pixels_normal(DP_Pixel15 *dst, DP_Pixel15 *src, int pixel_count, uint16_t opacity)
{
...
#else
static void DP_blend_pixels_normal(DP_Pixel15 *dst, DP_Pixel15 *src, int pixel_count, uint16_t opacity)
{
    blend_pixels_alpha_op(dst, src, pixel_count, to_fix(opacity), blend_normal);
}
#endif
